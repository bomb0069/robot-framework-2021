...
- จะมี Keyword หลักได้เพียงอันเดียวในไฟล์นั้น
  - กรณีที่มี Agruments ไม่เหมือนกัน ต้องแยกไฟล์เทสออกจากกัน
  - ทุก ๆ Test Cases ที่อยู่ในไฟล์นี้ ต้องใช้ Keyword หลักเดียวกัน ต่างกันแค่ Agruments ที่ใส่เข้าไปในแต่ละ Test Case
- ถ้า Keyword หลักที่ใช้เป็น Keyword ที่เราสร้างเอง ทุก ๆ Test Cases จะต้องใช้ Step หรือ Workflows เดียวกันทั้งหมด
  - ถ้าจะให้ดี Keyword นั้นควรจะอยู่ที่เดียวกับที่รัน Test เพื่อจะได้เห็นว่าแต่ละ Test Cases มี Steps/Workflows อะไรบ้าง (แยกก็ได้ ถ้ามีความจำเป็นจริง ๆ)
- ใส่ชื่อของตัวแปลไว้บนหัว Column เพื่อให้อ่านง่าย

## ลองใช้ Test Template

ลองมาตรวจสอบ Test Cases ที่เราเขียนไว้ ตามเงื่อนไขก่อหน้านี้ ก็จะได้ว่า Keyword หลักของทุก ๆ Test Cases ของ Login ก็คือ `Login ผิดพลาด จะต้องแสดงข้อความ Error` แถมยังใช้ Agruments ชุดเดียวกัน แถม Steps/Workflows ของการ Test ยังเหมือนกันอีกด้วย เพราะฉะนั้นเราก็สามารถแปลง มาใช้ Test Template ได้ดังตัวอย่างข้างล่างนี้
...
- บรรทัดที่ 2: กำหนดว่าเทสไฟล์นี้ จะให้ทำงานเป็นแบบ Test Template และจะใช้ Keyoword หลักที่ชื่อ `Login ผิดพลาด จะต้องแสดงข้อความ Error` สำหรับทุก ๆ Test Cases
- บรรทัดที่ 5-10: กำหนดชื่อของแต่ละ Test Case ให้อยู่ใน Column แรก และให้เอา  Agruments ต่าง ๆ มาใส่ใน Column ต่อ ๆ มา ซึ่งกรณีนี้มี Agruments จำนวน 3 ตัว ก็เอามาใส่แล้วแยก Column ไป
...
## สามารถใช้ Template ใน Test Cases ได้ แต่ไม่แนะนำ
